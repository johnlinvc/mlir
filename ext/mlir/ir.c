...
static VALUE ir_test(VALUE self) {
  return INT2NUM(ir_main());
}

void Init_ir(void){
  rb_ir = rb_define_module("MLIR");
  rb_cSystemExtension = rb_define_class_under(rb_ir, "Extension", rb_cObject);
  rb_define_singleton_method(rb_cSystemExtension, "test", ir_test, 0);
